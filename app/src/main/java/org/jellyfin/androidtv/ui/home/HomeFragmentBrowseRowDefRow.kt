...
class HomeFragmentBrowseRowDefRow(
	...
	override fun addToRowsAdapter(context: Context, cardPresenter: CardPresenter, rowsAdapter: MutableObjectAdapter<Row>) {
		...
		val rowAdapter = when (browseRowDef.queryType) {
			...
			QueryType.MergedContinueWatching -> ItemRowAdapter(context, browseRowDef.resumeQuery, browseRowDef.mergedNextUpQuery, browseRowDef.preferParentThumb, browseRowDef.isStaticHeight, cardPresenter, rowsAdapter)
